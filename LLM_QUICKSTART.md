...
|---|---|---|
| OMC | Clear | `Run /autopilot with: "If my MISSION.md is still unset, elicit it from me first (one sentence on what this project is; main outcomes; adjacent features I'm choosing NOT to build). Stamp MISSION.md with my answers. Then write a plan in .osc/plans/active/ for <task> using .osc/plans/handoff-template.md."` |
| OMC | Fuzzy | `Run /deep-interview. Tell it your MISSION.md is unset AND your first task is fuzzy — it will cover both in one interview, stamp MISSION.md, and write the plan in .osc/plans/active/.` |
